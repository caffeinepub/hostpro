...
export interface _SERVICE {
  'checkDomainAvailability' : ActorMethod<[string], boolean>,
  'getAllCheckedDomains' : ActorMethod<[], Array<[string, boolean]>>,
  'getAllContactForms' : ActorMethod<[], Array<ContactForm>>,
  'getAllNewsletterEmails' : ActorMethod<[], Array<string>>,
  'signUpForNewsletter' : ActorMethod<[string], undefined>,
