...
export class Backend implements backendInterface {
    ...
    async checkDomainAvailability(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkDomainAvailability(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllCheckedDomains(): Promise<Array<[string, boolean]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCheckedDomains();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async signUpForNewsletter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.signUpForNewsletter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
